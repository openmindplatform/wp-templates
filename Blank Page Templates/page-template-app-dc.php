...
<html>
	<head>
		...
		<style>			
			...
			#custom-header-desktop #OpenMind-site-link {
				padding-top: 10px;	
				margin-right: 30px;		
			}
			
			#OpenMind-site-link li{
				list-style-type: none;
			}
			
			#OpenMind-site-link li a{
			...
			#custom-header-desktop #OpenMind-site-link li a:hover{
				opacity: 0.7;
			...
			#custom-header-mobile #OpenMind-site-link {
				padding-top: 10px;
				margin-right: 15px;		
			}
			
			#custom-header-mobile #OpenMind-site-link li {
				text-align: right;
			}
			
			#custom-header-mobile #OpenMind-site-link li a{
				font-size: 16px;
			}
...
<body class="openMind-app">
	<div id="custom-header-desktop">
		<div id="OpenMind-logo">
			<img src="https://openmindplatform.org/wp-content/uploads/2018/06/OpenMind_smaller.png">
		</div>
		<ul id="OpenMind-site-link">
			<li><a href="https://openmindplatform.org/">Learn about OpenMind</a></li>
		</ul>
	</div>
